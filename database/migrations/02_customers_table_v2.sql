-- ============================================
-- MIGRATION PART 2: Customers Table (V2 - Simplified)
-- ============================================
...
ALTER TABLE customers ADD CONSTRAINT customers_loyalty_points_check
  CHECK (loyalty_points >= 0);

ALTER TABLE customers ADD CONSTRAINT customers_unique_email_per_restaurant
  UNIQUE (restaurant_id, email);

ALTER TABLE customers ADD CONSTRAINT customers_email_or_phone_required
...
-- Verification - mostra tutte le colonne
SELECT column_name, data_type, column_default
FROM information_schema.columns
WHERE table_name = 'customers'
ORDER BY ordinal_position;

-- Test insert di un customer anonimo
INSERT INTO customers (restaurant_id, name, is_registered, is_anonymous)
SELECT id, 'Test Cliente Incognito', false, true
FROM restaurants
LIMIT 1
RETURNING id, name, is_anonymous, loyalty_tier, loyalty_points;
